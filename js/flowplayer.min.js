...
!function (e) {
    ...
    e.fn.flowplayer = function (t, n) {
        ...
        var l = {
            pick: function (t) {
                ...
                if (flowplayer.support.video && u.prop("autoplay") && v(l.sources) ? u.one("timeupdate", p) : p(), is_absolute || s.rtmp || (c = e("<img/>").attr("src", c)[0].src), r)r.__play(c); else {
    ...
    var m, h = e("<video/>")[0], y = {
        ...
        return m ? m.attr({type: i(t.type), src: t.src}) : m = e("<video/>", {
            src: t.src,
            type: i(t.type),
            "class": "fp-engine",
            autoplay: "autoplay",
        ...
        return s = {
            pick: function (e) {
                ...
                if (p.splash && !d)u = b(n).prependTo(i), c.inlineVideo || u.css({
                    position: "absolute",
                    top: "-9999em"
                }), f.length && u.append(f.attr("default", "")), p.loop && u.attr("loop", "loop"), d = u[0]; else {
                    d = u[0];
                    var a = u.find("source");
    ...
    e(document).bind(M ? "fullscreenchange" : S + "fullscreenchange", function (t) {
        ...
        if (t.conf.fullscreen) {
            ...
            n.bind("mousedown.fs", function () {
                ...
                if (o.index > 0)t.play(o.index), o.index = 0; else if (o.pos && !isNaN(o.pos)) {
                    var n = function () {
    ...
    (flowplayer.support.touch || L) && flowplayer(function (t, n) {
        ...
        if (t.conf.embed !== !1) {
            ...
            }).appendTo(a), r = e("<div/>", {"class": "fp-embed-code"}).append("<label>Paste this HTML code on your site to embed.</label><textarea/>").appendTo(a), s = e("textarea", r);
            t.embedCode = function () {
                var a = t.video, o = a.width || n.width(), r = a.height || n.height(), s = e("<div/>", {
                    "class": "flowplayer",
                    css: {width: o, height: r}
...
flowplayer(function (e, o) {
    ...
    if ("file:" == location.protocol && (n = "localhost"), e.load.ed = 1, r.hostname = n, r.origin = i || location.href, i && o.addClass("is-embedded"), "string" == typeof t && (t = t.split(/,\s*/)), t && "function" == typeof key_check && key_check(t, n))r.logo && o.append(a("<a>", {
        "class": "fp-logo",
        href: i
    }).append(a("<img/>", {src: r.logo}))); else {
        var s = a("<a/>").attr("href", "http://flowplayer.org").appendTo(o);
        a(".fp-controls", o);
        var p = a('<div class="fp-context-menu"></div>').appendTo(o);
